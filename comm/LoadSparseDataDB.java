 ...
 * @author jhyeh
 */
public class LoadSparseDataDB {
    public int umax, umin, tmax, tmin;
    
    // fetch two-dim raw data
    public SparseMatrixDB loadRaw(String fname) {
        try {
            ...
            SparseMatrixDB data = new SparseMatrixDB(rows, cols);
    ...
    public SparseMatrixDB loadRawTransposed(String fname) {
        try {
            BufferedReader br = new BufferedReader(new FileReader(fname));
            String line="";
            umax = Integer.MIN_VALUE;
            ...
            SparseMatrixDB data = new SparseMatrixDB(cols, rows);
